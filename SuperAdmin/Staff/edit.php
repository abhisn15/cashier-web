...
<head>
  ...
  <title>SuperAdmin | Edit Data Staff</title>
...
<body>
      ...
      <ul class="space-y-2 font-medium">
        ...
        <li>
          ...
          <ul class=" py-2 space-y-2">
            ...
            <li>
              <a href="../Staff.php" class="flex items-center w-full p-2 transition duration-75 rounded-lg pl-11 group bg-orange-400 text-white">Staff</a>
            </li>
          </ul>
        </li>
        <li>
  ...
  <div class="sm:pl-8 py-5 mx-10 sm:ml-64 sm:mr-10">
    <h1 class="text-2xl">Edit Data Pelanggan</h1>
    <br>
    <div class="text-xl flex flex-row items-center gap-4">
      <a href="../Users.php" class="text-gray-500">Users</a>
      <span class="text-gray-500">/</span>
      <a href="../Staff.php" class="text-gray-500">Staff</a>
      <span class="text-gray-500">/</span>
      <a href="#" class="text-orange-500">Edit Data Staff</a>
    </div>
          ...
          <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
              <div class="text-gray-600">
                <p class="font-medium text-lg">Edit Data Staff</p>
              ...
              <div class="lg:col-span-2">
                <form method="POST" action="">
                  <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                    <input type="hidden" name="id" value="<?php echo htmlspecialchars($staff[0]['id']); ?>">

                    <div class="md:col-span-5">
                      <label for="name">Nama Lengkap</label>
                      <input type="text" name="name" id="name" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="<?php echo htmlspecialchars($staff[0]['nama']); ?>" />
                    </div>

                    <div class="md:col-span-5">
                      <label for="email">Email Address</label>
                      <input type="text" name="email" id="email" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="<?php echo htmlspecialchars($staff[0]['email']); ?>" placeholder="email@domain.com" />
                    </div>

                    <div class="md:col-span-3">
                      <label for="no_hp">Nomor Telepon</label>
                      <input type="number" name="no_hp" id="no_hp" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" oninput="validatePhoneNumber(this)" value="<?php echo htmlspecialchars($staff[0]['no_hp']); ?>" placeholder="" />
                    </div>
                    ...
                    <div class="md:col-span-2">
                      ...
                      <select name="role" id="role" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50">
                        <?php foreach ($roles as $role) : ?>
                          <option value="<?php echo $role ?>" <?php echo ($role == htmlspecialchars($staff[0]['role'])) ? 'selected' : ''; ?>>
