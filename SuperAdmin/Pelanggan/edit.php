...
<head>
  ...
  <title>SuperAdmin | Edit Data Pelanggan</title>
...
<body>
      ...
      <ul class="space-y-2 font-medium">
        ...
        <li>
          ...
          <ul class=" py-2 space-y-2">
            <li>
              <a href="../Pelanggan.php" class="flex items-center w-full p-2 transition duration-75 rounded-lg pl-11 group bg-orange-400 text-white">Pelanggan</a>
            </li>
            <li>
  ...
  <div class="sm:pl-8 py-5 mx-10 sm:ml-64 sm:mr-10">
    ...
    <div class="text-xl flex flex-row items-center gap-4">
      ...
      <a href="../Pelanggan.php" class="text-gray-500">Pelanggan</a>
      <span class="text-gray-500">/</span>
      <a href="#" class="text-orange-500">Edit Data Pelanggan</a>
    </div>
