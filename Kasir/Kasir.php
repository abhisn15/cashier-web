  ...
  <div class="sm:pl-8 py-5 sm:ml-64 sm:mr-10">
    ...
    <div class="flex justify-center mt-4">
      <form action="" method="POST" class="flex items-center gap-4">
        <input type="text" name="kode_barang" placeholder="Masukkan Kode Barang" class="border p-2 rounded-lg" required>
        <button type="submit" name="tambah_keranjang" class="bg-orange-400 text-white p-2 rounded-lg">Tambah ke Keranjang</button>
      </form>
    </div>
